<?php
if(isset($_GET['url'])&&isset($_GET['popup_id'])&&isset($_GET['cid'])){
    if(isset($_GET['user_id'])){
        ...
        try{
            ...
            $stmt = $db->prepare("INSERT INTO popup_access (popup_id,user_id,cid,access_id) VALUES (?,?,?,?)");
            $stmt->execute([$_GET['popup_id'],$_GET['user_id'],$_GET['cid'],$_GET['access_id']]);
